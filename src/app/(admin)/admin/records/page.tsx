...
import CertificateForm from "@/components/admin/CertificateForm"; // تأكد من وجود هذا المكون
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] p-8 md:p-12 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Form Section - New Authorisation */}
        <motion.section 
        ...
        {/* Records Library Section - القائمة السفلية */}
        <section>
          ...
          {/* هنا يمكنك وضع المكون الذي يعرض الكروت الثلاثة التي ظهرت في صورتك */}
